      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <br className="hidden sm:inline" /> {/* Optional: Keep or remove based on desired line break */}
            Expert Consulting
          </motion.h1>
          <motion.p
            variants={fadeIn}
        ...
        <div className="relative w-full min-h-[550px] md:min-h-[600px] mt-8 md:mt-12 flex items-center justify-center">
          ...
          <div className="absolute left-1 md:left-2 lg:left-4 top-1/2 -translate-y-1/2 z-30">
            <motion.button
          ...
          <AnimatePresence initial={false} custom={direction} mode="popLayout">
             {(() => {
                ...
                return (
                  ...
                  >
                    <div className="bg-white/95 backdrop-blur-sm rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 shadow-xl border border-blue-100 overflow-hidden">
          ...
          <div className="absolute right-1 md:right-2 lg:right-4 top-1/2 -translate-y-1/2 z-30">
            <motion.button
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
              onClick={nextCard}
          ...
          {/* Progress Indicators */}
           <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 flex gap-2 z-20">
             {serviceCards.map((_, index) => (
               <button
                 key={index}
                 onClick={() => setCurrent([index, index > currentCard ? 1 : -1])}
