            ...
            <div className="hidden md:flex items-center space-x-8">
              {navItems.map((item) => (
                <motion.a
                  ...
                  className="text-blue-900/80 relative group text-lg font-medium transition-colors"
            ...
            <div className="flex flex-col">
              {navItems.map((item) => (
                <a
                  ...
                  href={item.href}
                  onClick={(e) => handleNavClick(e, item.href)}
                  className="block px-6 py-3 text-blue-900 hover:bg-blue-100 transition-colors text-lg font-medium"
                >
                  {item.label}
                </a>
              ))}
